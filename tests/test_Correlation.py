...
def test_approx_correlation(testfiles):
    ...
    approx_corr = c._Correlation__aprox_correlation(t1_fft, t2_fft)
...
def test_approx_correlation_error(testfiles):
    ...
    approx_corr_all_coeff = c._Correlation__aprox_correlation(t1_fft, t2_fft)

    approx_corr = c._Correlation__correlate(t1, t2, 0.04)
    ...
    assert abs(real_corr - approx_corr) <= 0.04
